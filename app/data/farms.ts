...
export const farms: Farm[] = [
  {
    ...
    area: "28 acres",
    varieties: ["Arabica SLN 9", "Chandragiri"],
  ...
  },
  {
    ...
    area: "32 acres",
    varieties: ["Arabica S795", "Arabica Chandragiri"],
  ...
  },
  {
    ...
    established: 2000,
    description:
      "Durga Madhav Coffee Estate is a family-run farm in the Similiguda area, known for its richly flavoured natural-processed Arabica. The estate follows traditional cultivation practices with minimal chemical inputs, relying on the natural fertility of the Eastern Ghats soil.",
    story:
  ...
  },
  {
    ...
    area: "35 acres",
    varieties: ["Arabica S795", "Arabica SLN 9"],
    processing: ["washed", "natural", "honey"],
  ...
  },
  {
    ...
    elevation: "900–1100m",
    area: "22 acres",
    varieties: ["Arabica S795", "Chandragiri"],
    processing: ["washed", "natural"],
  ...
  },
  {
    ...
    established: 2005,
    description:
      "Laxmi Plantation is a well-respected Arabica estate in the Kotpad region, producing rich, full-bodied coffees that are well suited to espresso blends and commercial roasting. The estate has built a loyal customer base among domestic roasters who value the consistency and character of Koraput Arabica.",
    story:
  ...
  },
  {
    ...
    elevation: "960–1150m",
    area: "23 acres",
    varieties: ["Arabica SLN 9", "Arabica S795"],
