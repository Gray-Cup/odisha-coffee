...
export function meta() {
  return [
    ...
    { name: "description", content: generateDescription("Read the Privacy Policy for Gray Cup Enterprises Private Limited covering data collection, usage, retention and security for customers and partners.") },
  ];
}
