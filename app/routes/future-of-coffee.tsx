...
export function meta() {
  return [
    ...
    {
      name: "keywords",
      content: "climate change, coffee sustainability, wildlife conservation, endangered species, green corridors, IUCN Red List, specialty coffee",
    },
    { property: "og:title", content: generateTitle("Every Cup Has a Climate Story") },
    {
    ...
    { property: "og:image", content: "https://odishacoffee.com/og/future-of-coffee.webp" },
    { property: "og:image:width", content: "1200" },
    { property: "og:image:height", content: "630" },
    { property: "og:image:alt", content: "Every Cup Has a Climate Story - The Future of Coffee & Conservation" },
  ];
}
