...
export function meta() {
  return [
    ...
    { name: "description", content: generateDescription("Legal disclosure and company information for Gray Cup Enterprises Private Limited including registration details, GST and contact information.") },
  ];
}
