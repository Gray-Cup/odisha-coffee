...
export function links() {
  return [{ rel: "canonical", href: "https://odishacoffee.com/about" }];
}
            ...
            <div className="flex flex-col border-2 border-odisha-black bg-white p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  className="text-odisha-black/60 hover:text-odisha-red transition-colors"
                  target="_blank"
                  to="https://github.com/nermalcat69"
                >
                  <FaGithub size={18} />
                </Link>
                <Link
                  className="text-odisha-black/60 hover:text-odisha-red transition-colors"
                  target="_blank"
                  to="https://www.linkedin.com/in/nermalcat69/"
                >
                  <FaLinkedin size={18} />
                </Link>
                <Link
                ...
                <Link
                  className="text-odisha-black/60 hover:text-odisha-red transition-colors"
                  target="_blank"
                  to="https://instagram.com/arjun_sustains"
                >
                  <FaInstagram size={18} />
                </Link>
                <Link
                  className="text-odisha-black/60 hover:text-odisha-red transition-colors"
                  target="_blank"
                  to="mailto:arjunaditya@icloud.com"
                >
                  <IoIosMail size={20} />
                </Link>
              </div>
