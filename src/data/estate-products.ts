...
export const estateProducts: EstateProduct[] = [
  ...
  },
  {
    ...
    image: "koraput-naturals.jpg",
    description:
      "AA-grade natural-processed green beans from Koraput, Odisha, whole-cherry dried on raised beds for 25–30 days. Screen 14+ sorted, moisture 11–13%. A value-focused naturals lot for high-volume roasters and blenders who want fruit-forward character without specialty pricing.",
