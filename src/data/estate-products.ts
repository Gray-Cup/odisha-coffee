...
export const estateProducts: EstateProduct[] = [
  ...
  },
  {
    ...
    image: "koraput-naturals.jpg",
    description:
      "Commercial-grade natural-processed green beans, whole-cherry dried on raised beds for 25–30 days. Screen 14+ sorted, moisture 11–13%. A value-focused naturals lot for high-volume roasters and blenders who want fruit-forward character without specialty pricing.",
    ...
    screenSize: "Screen 14+",
    brewingNotes:
      "Recommended roast: medium-dark to dark. The Robusta component adds body and crema; suited to commercial espresso blends and dark roast programmes.",
  },
  {
